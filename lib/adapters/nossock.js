 ...
 */
var scanSpecs = function(basePath) {
 ...
 * Losin Factory
 */
var LosinFactory = function(cfg, specs) {
    ...
    this.createLosin = function(socket) {
        return new Losin(socket, registry, config);
    };
...
module.exports = {
    Losin: NossockAdapter,
    LosinFactory: LosinFactory
};
